...
public class Movimiento_Ascensor2 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if(PisoActual!=0){
            if(cuarto.GetComponent<Cuarto_Control>().Movi2 == MoviAscensor2.Bajando && piso_0.piso_0 == true){
            pisnum = 0;
            } 
            if(cuarto.GetComponent<Cuarto_Control>().Movi2 == MoviAscensor2.Bajando && piso_1.piso_1 == true){
                pisnum = 1;
            } 
            if(cuarto.GetComponent<Cuarto_Control>().Movi2 == MoviAscensor2.Bajando && piso_2.piso_2 == true){
                pisnum = 2;
            } 
            if(cuarto.GetComponent<Cuarto_Control>().Movi2 == MoviAscensor2.Bajando && piso_3.piso_3 == true){
                pisnum = 3;
            }  
            if(cuarto.GetComponent<Cuarto_Control>().Movi2 == MoviAscensor2.Bajando && piso_4.piso_4 == true){
                pisnum = 4;
            }  
            if(cuarto.GetComponent<Cuarto_Control>().Movi2 == MoviAscensor2.Bajando && piso_5.piso_5 == true){
                pisnum = 5;
            }  
            if(cuarto.GetComponent<Cuarto_Control>().Movi2 == MoviAscensor2.Bajando && piso_6.piso_6 == true){
                pisnum = 6;
            }  
            if(cuarto.GetComponent<Cuarto_Control>().Movi2 == MoviAscensor2.Bajando && piso_7.piso_7 == true){
                pisnum = 7;
            }  
            if(cuarto.GetComponent<Cuarto_Control>().Movi2 == MoviAscensor2.Bajando && piso_8.piso_8 == true){
                pisnum = 8;
            }  
            if(cuarto.GetComponent<Cuarto_Control>().Movi2 == MoviAscensor2.Bajando && piso_9.piso_9 == true){
                pisnum = 9;
            }  
            if(cuarto.GetComponent<Cuarto_Control>().Movi2 == MoviAscensor2.Bajando && piso_10.piso_10 == true){
                pisnum = 10;
            }  
            if(cuarto.GetComponent<Cuarto_Control>().Movi2 == MoviAscensor2.Bajando && piso_11.piso_11 == true){
                pisnum = 11;
            }  
            if(cuarto.GetComponent<Cuarto_Control>().Movi2 == MoviAscensor2.Bajando && piso_12.piso_12 == true){
                pisnum = 12;
            }  
            /*if(cuarto.GetComponent<Cuarto_Control>().Movi2 == MoviAscensor2.Bajando && piso_13.piso_13 == true){
                pisnum = 13;
            }  
            if(cuarto.GetComponent<Cuarto_Control>().Movi2 == MoviAscensor2.Bajando && piso_14.piso_14 == true){
                pisnum = 14;
            }  
            if(cuarto.GetComponent<Cuarto_Control>().Movi2 == MoviAscensor2.Bajando && piso_15.piso_15 == true){
                pisnum = 15;
            }  
            if(cuarto.GetComponent<Cuarto_Control>().Movi2 == MoviAscensor2.Bajando && piso_16.piso_16 == true){
                pisnum = 16;
            }  
            if(cuarto.GetComponent<Cuarto_Control>().Movi2 == MoviAscensor2.Bajando && piso_17.piso_17 == true){
                pisnum = 17;
            }  
            if(cuarto.GetComponent<Cuarto_Control>().Movi2 == MoviAscensor2.Bajando && piso_18.piso_18 == true){
                pisnum = 18;
            }  
            if(cuarto.GetComponent<Cuarto_Control>().Movi2 == MoviAscensor2.Bajando && piso_19.piso_19 == true){
                pisnum = 19;
            }  
            if(cuarto.GetComponent<Cuarto_Control>().Movi2 == MoviAscensor2.Bajando && piso_20.piso_20 == true){
                pisnum = 20;
            }*/
        }
           
        
        if (pisnum>PisoActual && cuarto.GetComponent<Cuarto_Control>().Movi2 == MoviAscensor2.Subiendo){ //para subir el ascensor
            //Debug.Log("Subiendo");
            PisoActual++;
            transform.position = new Vector3(transform.position.x,PisoActual/2,transform.position.z);
            Thread.Sleep(500);
            cuarto.GetComponent<Cuarto_Control>().llamada2=disponible2.noallegado;                        
        }

        if (pisnum<PisoActual && cuarto.GetComponent<Cuarto_Control>().Movi2 == MoviAscensor2.Bajando ){    // para bajar el ascensor  
            //Debug.Log("Bajando");
            PisoActual--; 
            transform.position = new Vector3(transform.position.x,PisoActual/2,transform.position.z);
            Thread.Sleep(500);
        ...
        if (PisoActual == pisnum){
            if(cuarto.GetComponent<Cuarto_Control>().llamada2!=disponible2.origen){
                cuarto.GetComponent<Cuarto_Control>().llamada2=disponible2.llego;
            }
            
            //Debug.Log("Llegaste a tu destino");
            /*if (pisnum==20){
                Thread.Sleep(2000);
                cuarto.GetComponent<Cuarto_Control>().Movi2 = MoviAscensor2.Bajando;
            ...
            if (pisnum==0){
                Thread.Sleep(2000);
                piso_1.piso_1 = false;
                cuarto.GetComponent<Cuarto_Control>().Movi2 = MoviAscensor2.Subiendo;
                cuarto.GetComponent<Cuarto_Control>().llamada2=disponible2.origen;
